        ...
        <div class="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="rounded-2xl bg-white p-6 shadow-md hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-sm font-semibold text-slate-600">Total de Usuarios</h3>
            ...
            <div class="space-y-2">
              ...
              <p class="text-xs text-slate-500">Usuarios registrados en el sistema</p>
            </div>
          </div>
          ...
          <div class="rounded-2xl bg-white p-6 shadow-md hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-sm font-semibold text-slate-600">Total de Habitaciones</h3>
            ...
            <div class="space-y-2">
              ...
              <p class="text-xs text-slate-500">Habitaciones disponibles</p>
            </div>
          </div>
                ...
                @for (reservation of recentReservations.slice(0, 3); track reservation.id) {
                  <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <p class="text-xs text-slate-600">{{ reservation.status }}</p>
                    </div>
...
export class DashboardPage implements OnInit {
  ...
  loadStatistics(): void {
    ...
    this.roomService.getRooms().subscribe(rooms => {
      this.totalRooms = rooms.filter(r => r.available).length;
    });

    // Load reservations count and recent
